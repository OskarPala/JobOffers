...
class RedisOffersCacheIntegrationTest extends BaseIntegrationTest {
    ...
    @Test
    public void should_save_offer_in_redis_cache_and_then_invalidate_by_time_to_live() throws Exception {
        //step 1: someUser was registered with some password
        //given && when
        ...
        //step 4: should invalidate cache after 1 second
        await()
