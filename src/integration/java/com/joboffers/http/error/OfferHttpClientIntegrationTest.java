...
public class OfferHttpClientIntegrationTest implements SampleJobOffersResponse {
    ...
    void should_throw_exception_204_when_status_is_204_no_content() {
        ...
        wireMockServer.stubFor(WireMock.get("/offers")
                .willReturn(WireMock.aResponse()
                        ...
                        .withHeader(CONTENT_TYPE_HEADER_KEY, APPLICATION_JSON_CONTENT_TYPE_VALUE)
                        .withBody("""
                                [1, 2, 3, 4, 5, 6, 82, 81, 53, 93, 50, 54, 31, 88, 15, 43, 79, 32, 43]
                                """.trim()
                        )));
        //when
        Throwable throwable = catchThrowable(() -> remoteOfferClient.fetchOffers());
    ...
    @Test
    void should_throw_exception_500_when_response_delay_is_5000_ms_and_client_has_1000_read_timeout() {
        //given
        wireMockServer.stubFor(WireMock.get("/offers")
                .willReturn(WireMock.aResponse()
                        .withStatus(HttpStatus.SC_OK)
    ...
    @Test
    void should_throw_exception_404_when_http_service_returns_not_found_status() {
        //given
        wireMockServer.stubFor(WireMock.get("/offers")
                .willReturn(WireMock.aResponse()
    ...
    @Test
    void should_throw_exception_401_when_http_service_returns_unauthorized_status() {
        //given
        wireMockServer.stubFor(WireMock.get("/offers")
                .willReturn(WireMock.aResponse()
