...
public class ApiValidationErrorTest extends BaseIntegrationTest {
    @Test
    @WithMockUser
    public void should_return_400_bad_request_when_empty_and_null_in_offer_save_request() throws Exception {
        //given & when
